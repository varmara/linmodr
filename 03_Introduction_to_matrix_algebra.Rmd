...
По значению этого числа можно *опредилить* есть ли у матрицы некоторые свойства (например, обратима ли матрицв).  
...
Подобранные параметры - это оценки некоторых параметров, описывающих связь между зависимой перменной и предиктором в популяции.   
