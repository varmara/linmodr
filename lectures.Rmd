...
### 03 Описательная статистика (версия 2019г.)
...
### 04 Тестирование гипотез (версия 2019г.)
...
### 05 Простая линейная регрессия  (15 окт, ВХ)
...
### 06 Основы линейной алгебры (19 окт., ВХ)
...
### 07 Описание, проверка значимости и валидности линейной модели (22 окт., МВ)

- Презентация:
    + Часть 1 [07.1_model_description.html](07.1_model_description.html)
    + Часть 2 [07.2_model_validation.html](07.2_model_validation.html)
...
### 08 Множественная линейная регрессия. Выбор оптимальной модели. (26 окт., ВХ)
...
### 09 Модели с непрерывными и дискретными предикторами (ANCOVA) (29 окт., ВХ)
...
### 10 Однофакторный дисперсионный анализ (2 нояб., МВ)
...
### 11 Многофакторный дисперсионный анализ (5 ноя., МВ)
...
### 12 GLM для нормально распределенных данных (9 нояб., МВ)
...
### 13 GLM для счетных данных (12 нояб., МВ)
...
- Код:
    + [13_GLM_count_code.R](13_GLM_count_code.R)
    + [13_GLM_count_practice.R](13_GLM_count_practice.R)
- Данные:
    + [Pollinators_Montero-Castano, Vila, 2015.xlsx](data/Pollinators_Montero-Castano, Vila, 2015.xlsx)

<!-- - Примерное решение: [13_GLM_count_practice_solution.R](13_GLM_count_practice_solution.R) -->

### 14 GLM для бинарных данных (=логистическая регрессия) (16 нояб., ВХ)
...
### 15 GLMM для нормально-распределенных данных (19 нояб., МВ)
...
### 16 Моделирование структуры дисперсии в смешаных моделях (23 нояб., ВХ)
...
### 17 GLMM для счетных данных (26 нояб., МВ)
...
### 18 GLMM для бинарных данных (30 нояб., ВХ)
