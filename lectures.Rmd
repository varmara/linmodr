...
### 07 Описание, проверка значимости и валидности линейной модели (19 окт., МВ)
...
### 08 Множественная линейная регрессия. Выбор оптимальной модели. (22 окт., ВХ)
...
### 09 Модели с непрерывными и дискретными предикторами (ANCOVA) (26 окт., ВХ)
...
### 10 Однофакторный дисперсионный анализ (29 окт., МВ)
...
### 11 Многофакторный дисперсионный анализ (2 ноя., МВ)
...
### 12 GLM для нормально распределенных данных (5 нояб., МВ)
...
### 13 GLM для счетных данных (9 нояб., МВ)
...
### 14 GLM для бинарных данных (=логистическая регрессия) (12 нояб., ВХ)
...
### 15 GLMM для нормально-распределенных данных (16 нояб., МВ)
...
### 16 Моделирование структуры дисперсии в смешаных моделях (19 нояб., ВХ)
...
### 17 GLMM для счетных данных (23 нояб., МВ)
...
### 18 GLMM для бинарных данных (26 нояб., ВХ)
