...
Правдоподобие (likelihood) -  это соотверствие имеющихся данных тому, что можно получить при определенных значениях параметров модели. 
...
Чтобы измерить правдоподобие нам нужно оценить вероятность получения имеющегося набора значений зависимой переменной при  заданных параметрах модели, описывающей связь между зависимой переменной и предикторами. 
