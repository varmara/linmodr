...
\it{Yakovis Y., Artemieva A.} "Bored to Death: Community-Wide Effect of Predation on a Foundation Species in a Low-Disturbance Arctic Subtidal System" PLOS, 2015. DOI: 10.1371/journal.pone.0132973
\end{small}
...
\textbf {Общий вид друзы морских желудей}

\includegraphics[width=\linewidth]{images/druse.png}


\column{0.5 \textwidth}

\textbf{\it{Balanus crenatus}, просверленные улитками \it{Boreotrophon clathratus}}


\includegraphics[width=\linewidth]{images/drilled_barnacle.png}
...
\textbf{Для ответа на поставленный вопрос целесообразно работать с мертвыми особями}
...
\fontsize{10 pt}{12}\selectfont

\resizebox{1\textwidth}{!}{
\begin{tabular}{L{0.25\textwidth} C{0.25\textwidth} L{0.5\textwidth}}
\hline\noalign{\smallskip}
...
\begin{tabular}{L{0.2\textwidth} L{0.2\textwidth} L{0.2\textwidth} L{0.2\textwidth} L{0.2\textwidth}}
...
Positionsecondary&1.261*&1.297*&1.224*&1.306*\\
Site2&-0.298&-0.290&0.205&-0.231 \\
\end{tabular}
}

\pause
\textbf{Выбор функции на совести исследователя!}
