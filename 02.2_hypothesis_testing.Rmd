...
## Пример тестовой статистики: Z-тест
  ...
  geom_vline(xintercept = -Z_large, size = 1, linetype = "dotted") +
    annotate(geom = "text", x = -Z_large, y = 0.1, hjust = 1.3,
      ...
      annotate(geom = "text", x = Z_large, y = 0.1, hjust = -0.3,
           label = "P(z[obs] >= z[0])", parse = TRUE) +
      annotate(geom = "text", x = -Z_large, y = 0.4, hjust = 1.1,
           label = "-z[0] == -1.5", parse = TRUE) +
      annotate(geom = "text", x = Z_large, y = 0.4, hjust = -0.1,
           label = "z[0] == 1.5", parse = TRUE) +
  ...
  geom_vline(xintercept = -Z_small, size = 1, linetype = "dotted") +
    annotate(geom = "text", x = -Z_small, y = 0.1, hjust = 1.1,
      ...
      annotate(geom = "text", x = Z_small, y = 0.1, hjust = -0.1,
           label = "P(z[obs] >= z[0])", parse = TRUE) +
      annotate(geom = "text", x = -Z_small, y = 0.4, hjust = 1.1,
           label = "-z[0] == -2.3", parse = TRUE) +
      annotate(geom = "text", x = Z_small, y = 0.4, hjust = -0.1,
           label = "z[0] == 2.3", parse = TRUE) +
...
- $\Delta = \bar x_1 - \bar x_2$ --- это разность между двумя средними значениями  
